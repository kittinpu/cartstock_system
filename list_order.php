                                        ...
                                        <td>
                                            ...
                                            <br><div class="row">
                                                ...
                                                <div class="col-md-8" align="left" style="margin-left: -45px;">
                                                    ...
                                                    <form action="insert_slip.php" method="POST" enctype="multipart/form-data">

                                                            <input type="file" name="order_slip" class="form-control-file" id="exampleInputFile" aria-describedby="fileHelp">

                                                            <input type="hidden" name="order_slip" value="<?php echo $row_pdd['order_slip']; ?>">
                                                            <input type="hidden" name="order_status" value="<?php echo $row_pdd['order_status']; ?>">
