                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <h4 class="m-t-0 header-title"><b>รายการข้อมูลการสั่งซื้อที่ค้างชำระเงิน</b></h4>
                                        </div>
                                    </div>
                                    <hr>
                                    <table data-toggle="table"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="pfile" data-align="center" data-sortable="true">รูปประจำตัวผู้ซื้อ</th>
                                        ...
                                        <tbody>
                                            <?php while ($row_pd = mysqli_fetch_assoc($res_pd)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="../img_member/<?php echo $row_pd['member_photo']; ?>" class="image-popup" title="รูปภาพรหัส : <?php echo $row_pd['member_fullname']; ?>">
                                                            <img width="70px" height="70px" src="../img_member/<?php echo $row_pd['member_photo']; ?>">
                                                        </a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <font color="blue">สถานะการทำรายการ</font> : <font color="red">ยังไม่ได้ชำระเงิน</font>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
