                                ...
                                <div class="portlet">
                                    <div class="portlet-heading bg-purple">
                                        <h3 class="portlet-title">
                                            แก้ไขรายละเอียดผู้ใช้งาน รหัส : <?php echo $member_id; ?>
                                        </h3>
                                    ...
                                    <div id="bg-inverse" class="panel-collapse collapse show">
                                        <div class="portlet-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="p-20">
                                                        <form class="form-horizontal" role="form" action="update_member.php" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-10">
                                                                    <input type="password" class="form-control" placeholder="Enter password" name="password" value="<?php echo $row_member['member_password'] ?>" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
