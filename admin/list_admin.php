...
<html>
    <head>
        <?php 
            include 'head.php'; 
            $sql = "SELECT * FROM sp_member_dt INNER JOIN sp_titlename_dt ON sp_member_dt.titlename_id = sp_titlename_dt.titlename_id WHERE member_status='$member_status2' ORDER BY member_id DESC";
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <h4 class="m-t-0 header-title"><b>รายการผู้ดูแลระบบ</b></h4>
                                        </div>
                                        <div align="right" class="col-6">
                                            <span class="label label-primary">
                                                มีจำนวนทั้งหมด <?php echo $count_ad['COUNTAD']; ?> รายการ
                                            </span>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="button-list">
                                        <a href="frm_admin.php" class="btn btn-primary waves-effect waves-light">
                                            <span class="btn-label"><i class="fa fa-user-secret"></i>
                                            </span>เพิ่มข้อมูล
                                        </a>
                                    </div>
                                            ...
                                            <?php while ($row_member = mysqli_fetch_assoc($res_member)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <font color="black">สิทธิ์ : </font><span class="label label-danger">ผู้ดูแลระบบ</span> <span class="label label-success">Administrator</span> <span class="label label-success">System</span><br>
                                                    ...
                                                    <td>
                                                        <div style="font-size: 20px;">
                                                            <a href="frm_update_admin.php?id=<?php echo $row_member['member_id']; ?>"><span class="fa fa-pencil-square-o"></span></a>
                                                            <a href="delete_admin.php?id=<?php echo $row_member['member_id']; ?>"><span class="fa fa-trash-o"></span></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php
