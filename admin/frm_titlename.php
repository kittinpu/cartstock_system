                                    ...
                                    <div id="bg-inverse" class="panel-collapse collapse show">
                                        <div class="portlet-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="p-20">
                                                        <form class="form-horizontal" role="form" action="insert_titlename.php" method="POST" enctype="multipart/form-data">
                                                            <div class="form-group row">
                                                                <label class="col-2 col-form-label">เนื้อหาคำนำหน้าชื่อ</label>
                                                                <div class="col-10">
                                                                    <input type="text" class="form-control" placeholder="Enter Titlename" name="titlename_detail" required>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-2">
